...
#define GCM_BNR_MAGIC_WORD_PREFIX_LENGTH	ntohl(0x0003)
#define GCM_BNR_MAGIC_WORD_SUFFIX_LENGTH	ntohl(0x0001)
#define GCM_BNR_MAGIC_WORD_OFFSET			ntohl(0x0000)
#define GCM_BNR_MAGIC_WORD_SUFFIX_OFFSET	ntohl(0x0003)
#define GCM_BNR_MAGIC_WORD_LENGTH			ntohl(0x0004)
#define GCM_BNR_GRAPHIC_DATA_OFFSET			ntohl(0x0020)
#define GCM_BNR_GRAPHIC_DATA_LENGTH			ntohl(0x1800)
#define GCM_BNR_GAME_NAME_OFFSET			ntohl(0x1820)
#define GCM_BNR_GAME_NAME_LENGTH			ntohl(0x0020)
#define GCM_BNR_DEVELOPER_OFFSET			ntohl(0x1840)
#define GCM_BNR_DEVELOPER_LENGTH			ntohl(0x0020)
#define GCM_BNR_FULL_TITLE_OFFSET			ntohl(0x1860)
#define GCM_BNR_FULL_TITLE_LENGTH			ntohl(0x0040)
#define GCM_BNR_FULL_DEVELOPER_OFFSET		ntohl(0x18a0)
#define GCM_BNR_FULL_DEVELOPER_LENGTH		ntohl(0x0040)
#define GCM_BNR_DESCRIPTION_OFFSET			ntohl(0x18e0)
#define GCM_BNR_DESCRIPTION_LENGTH			ntohl(0x0080)
